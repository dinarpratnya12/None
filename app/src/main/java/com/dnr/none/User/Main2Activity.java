    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent inte = new Intent(Main2Activity.this, BuatBiodata.class);
                startActivity(inte);
            }
        });
    ...
    public void RefreshList() {
        ...
        ListView01.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView arg0, View arg1, int arg2, long arg3) {
                ...
                final CharSequence[] dialogitem = {"Lihat Detail", "Update List", "Hapus List"};
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        switch (item) {
                            case 0:
                                ...
                                i.putExtra("tim", selection);
                                startActivity(i);
                                break;
                            case 1:
                                Intent in = new Intent(getApplicationContext(), UpdateBiodata.class);
                                in.putExtra("tim", selection);
                                startActivity(in);
                                break;
                            case 2:
                                SQLiteDatabase db = dbcenter.getWritableDatabase();
                                db.execSQL("delete from list where tim = '" + selection + "'");
                                RefreshList();
                                break;
                        }
                    }
